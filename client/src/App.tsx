...
// Purpose: one shared TanStack Query client for the whole app - every
// useQuery()/useMutation() in src/hooks reads/writes through this same
// cache, which is what lets e.g. StudentDashboard and ProfilePage reuse one
// ["students","me"] entry instead of each firing its own request.
