// Purpose: one place that defines every TanStack Query key used in this app,
// so an invalidateQueries() call after a mutation can never typo a key that
// a useQuery() elsewhere is actually listening on.
